<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("Value");
					i++;
...
<div id="container">
	<div id="header">
		User Task Form: secondary.setval
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Task Info</legend>
            	...
            	<div class="div_checkbox"><![CDATA[rest-all]]></div>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<div class="div_texbox">
                              		<input name="Value" type="text" class="textbox" id="Value" value="${Value}" />
                            		</div>
